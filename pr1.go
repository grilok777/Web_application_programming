...
func handlerPR1(w http.ResponseWriter, r *http.Request) {
	data := PageData{
	...
	// Викликаємо оновлену функцію parseTemplate з main.go
	parseTemplate("pr1.html").ExecuteTemplate(w, "layout", data)
}